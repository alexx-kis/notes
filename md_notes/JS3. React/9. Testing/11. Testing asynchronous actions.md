# 9.21 Тестирование асинхронных действий
...
- в каждом действии мы описываем сетевое действие, мы применяем пакет axios, которые прокидывается в виде extra-аргумента
